 ...
 * OpenRTB 2.3, and values are the keys of the substitution value map.
 */
var _MACRO_MAP = {
  'ID': 'id',
  'BID_ID': 'bidid',
...
var MACRO_PATTERN = (function() {
  return new RegExp('\\$\\{AUCTION_(' + Object.keys(_MACRO_MAP).join('|') + ')(:[A-Za-z0-9]+)?\\}', 'g');
})();
